...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["lazy-libs-account-wrapper-module"], {
  ...
  /***/
  function node_modulesAbpNgAccountFesm2015AbpNgAccountJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ACCOUNT_ROUTES", function () {
    ...
    __webpack_require__.d(__webpack_exports__, "AccountProviders", function () {
    ...
    var angular_oauth2_oidc__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! angular-oauth2-oidc */
    ...
    var snq__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! snq */
    ...
    function () {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onSubmit() {
          ...
          var tenant = this.store.selectSnapshot(_abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["SessionState"].getTenant);
          Object(rxjs__WEBPACK_IMPORTED_MODULE_11__["from"])(this.oauthService.fetchTokenUsingPasswordFlow(this.form.get('username').value, this.form.get('password').value, new _angular_common_http__WEBPACK_IMPORTED_MODULE_14__["HttpHeaders"](Object.assign({}, tenant && tenant.id && {
            __tenant: tenant.id
          ...
          */
          function () {
            return _this.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["GetAppConfiguration"]());
          ...
          */
          function () {
            /** @type {?} */
            var redirectUrl = Object(snq__WEBPACK_IMPORTED_MODULE_13__["default"])(
            /**
            * @return {?}
            */
            function () {
              return window.history.state;
            }).redirectUrl || (_this.options || {}).redirectUrl || '/';

            _this.store.dispatch(new _ngxs_router_plugin__WEBPACK_IMPORTED_MODULE_8__["Navigate"]([redirectUrl]));
          ...
          */
          function (err) {
            _this.toasterService.error(Object(snq__WEBPACK_IMPORTED_MODULE_13__["default"])(
            /**
            * @return {?}
            */
            function () {
    ...
    AccountService.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"])({
      factory: function AccountService_Factory() {
        return new AccountService(Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"])(_abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["RestService"]));
      },
    ...
    var _angular_forms__WEBPA2 = _angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"],
        ...
        minLength$1 = _angular_forms__WEBPA2.minLength,
        required$1 = _angular_forms__WEBPA2.required,
        email = _angular_forms__WEBPA2.email;
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.form = this.fb.group({
            ...
            password: ['', [required$1, Object(_ngx_validate_core__WEBPACK_IMPORTED_MODULE_4__["validatePassword"])(passwordRulesArr), minLength$1(requiredLength), maxLength$1(32)]],
        ...
        value: function onSubmit() {
          ...
          var tenant = this.store.selectSnapshot(_abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["SessionState"].getTenant);
          this.accountService.register(newUser).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["switchMap"])(
          /**
          * @return {?}
          */
          function () {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_11__["from"])(_this2.oauthService.fetchTokenUsingPasswordFlow(newUser.userName, newUser.password, new _angular_common_http__WEBPACK_IMPORTED_MODULE_14__["HttpHeaders"](Object.assign({}, tenant && tenant.id && {
              __tenant: tenant.id
            }))));
          ...
          */
          function () {
            return _this2.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["GetAppConfiguration"]());
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["tap"])(
          /**
          * @return {?}
          */
          function () {
            return _this2.store.dispatch(new _ngxs_router_plugin__WEBPACK_IMPORTED_MODULE_8__["Navigate"](['/']));
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["catchError"])(
          /**
          * @param {?} err
          * @return {?}
          */
          function (err) {
            _this2.toasterService.error(Object(snq__WEBPACK_IMPORTED_MODULE_13__["default"])(
            /**
            * @return {?}
            */
            function () {
    ...
    var _angular_forms__WEBPA3 = _angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"],
        minLength$2 = _angular_forms__WEBPA3.minLength,
        required$2 = _angular_forms__WEBPA3.required,
        maxLength$2 = _angular_forms__WEBPA3.maxLength;
    /** @type {?} */
    ...
    function () {
      ...
      _createClass(ChangePasswordComponent, [{
        ...
        value: function onSubmit() {
          ...
          if (this.form.invalid) return;
          this.inProgress = true;
          this.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["ChangePassword"]({
          ...
          */
          function () {
            ...
            */
            function error(err) {
              _this3.toasterService.error(Object(snq__WEBPACK_IMPORTED_MODULE_13__["default"])(
              /**
              * @return {?}
              */
              function () {
    ...
    var _angular_forms__WEBPA4 = _angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"],
        maxLength$3 = _angular_forms__WEBPA4.maxLength,
        required$3 = _angular_forms__WEBPA4.required,
        email$1 = _angular_forms__WEBPA4.email;
    ...
    function () {
      ...
      _createClass(PersonalSettingsComponent, [{
        ...
        value: function buildForm() {
          ...
          this.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["GetProfile"]()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["withLatestFrom"])(this.profile$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["take"])(1)).subscribe(
          /**
          * @param {?} __0
          * @return {?}
          */
        ...
        value: function submit() {
          ...
          if (this.form.invalid) return;
          this.inProgress = true;
          this.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["UpdateProfile"](this.form.value)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["finalize"])(
          /**
          * @return {?}
          */
          function () {
          ...
          */
          function () {
            _this5.toasterService.success('AbpAccount::PersonalSettingsSaved', 'Success', {
              life: 5000
            });
          });
        }
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_16__["__decorate"])([Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_9__["Select"])(_abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["ProfileState"].getProfile), Object(tslib__WEBPACK_IMPORTED_MODULE_16__["__metadata"])("design:type", rxjs__WEBPACK_IMPORTED_MODULE_11__["Observable"])], PersonalSettingsComponent.prototype, "profile$", void 0);
    ...
    function () {
      ...
      _createClass(TenantBoxComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.tenant = this.store.selectSnapshot(_abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["SessionState"].getTenant) ||
          /** @type {?} */
          {};
        ...
        value: function save() {
          ...
          if (this.tenant.name && !this.inProgress) {
            this.inProgress = true;
            this.accountService.findTenant(this.tenant.name).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["finalize"])(
            /**
            * @return {?}
            */
            function () {
            ...
            */
            function (err) {
              _this6.toasterService.error(Object(snq__WEBPACK_IMPORTED_MODULE_13__["default"])(
              /**
              * @return {?}
              */
              function () {
            ...
            */
            function (_ref4) {
              ...
              _this6.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_0__["SetTenant"](success ? _this6.tenant : null));
            });
          } else {
    ...
    var ACCOUNT_OPTIONS = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["InjectionToken"]('ACCOUNT_OPTIONS');
    /**
     * @fileoverview added by tsickle
    ...
    AccountModule.decorators = [{
      type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"],
      args: [{
        declarations: [AuthWrapperComponent, LoginComponent, RegisterComponent, TenantBoxComponent, ChangePasswordComponent, ManageProfileComponent, PersonalSettingsComponent],
